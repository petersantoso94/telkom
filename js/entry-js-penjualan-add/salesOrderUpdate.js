$(document).ready(function () {
    ...
    $(".price-range").each(function (i) {
        $('[data-toggle="popover"]').popover({trigger: 'hover'});
        $("#" + $(this).attr('id')).popover({trigger: 'hover'});
    });
    //get uom
    /*
     var dataUom;
...
//found parcel
    ...
    $("#btn-addRow").click(function () {
        $('#table-salesOrder tr:last').after('<tr id="row' + baris + '">' +
                '<td class="chosen-uom">' +
                '<div id="price-range-' + baris + '" class="price-range"><input type="hidden" class="inventory" style="width: 100px" id="inventory-' + baris + '" style="" name="inventory[]" value="' + $('#inventory-0').val() + '">' +
                ...
                '</td>' +
                '<td class="text-right">' +
                '<input type="text" class="maxWidth qty right input-theme" name="qty[]" maxlength="11" min="1" value="1" id="price-' + baris + '-qty">' + '</td>' +
                '<td class="text-right">' +
                '<input type="text" class="maxWidth price right numajaDesimal input-theme" name="price[]" maxlength="" value="0.00" id="price-' + baris + '">' + '</td>' +
                '<td class="text-right">' +
                '<input type="text" class="maxWidth discount numajaDesimal right input-theme" name="discount[]" min="0" max="100" id="price-' + baris + '-discount" value="0.00">' + '</td>' +
                '<td class="text-right">' +
                '<input type="text" class="maxWidth discountNominal numajaDesimal right input-theme" name="discountNominal[]" id="price-' + baris + '-discountNominal" value="0.00">' + '</td>' +
                '<td class="right subtotal" id="price-' + baris + '-qty-hitung">' + '0.00' + '</td>' +
                '<td>' +
