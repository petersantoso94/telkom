...
$(document).ready(function () {
    $("#searchInventory").keydown(function (event) {
        if (event.keyCode == 13) { //enter
            ...
            $.post(getSearchResultInventoryForQuotation, {id: $("#searchInventory").val()}).done(function (data) {
