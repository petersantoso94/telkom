...
$(document).ready(function () {
    ...
    $("#searchSalesReturn").keydown(function (event) {
        if (event.keyCode == 13) { //enter
            event.preventDefault();
            $.post(getResultSearchSR, {id: $("#searchSalesReturn").val()}).done(function (data) {
                $("#selectSalesReturn").html(data);
            });
        }
    });
