...
$(document).ready(function () {
    $("#searchSales").keydown(function (event) {
        if (event.keyCode == 13) { //enter
            event.preventDefault();
            $.post(getResultSearchSOCopy, {id: $("#searchSales").val()}).done(function (data) {
                $("#selectSales").html(data);
            });
        }
    });
